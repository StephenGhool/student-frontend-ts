...
export function RegisterUser() {
  ...
  const handleform = ({ currentTarget: input }) => {
    setuserdata({ ...newuser, [input.id]: input.value });
    console.log(newuser);
  };
  ...
  const registeruser = async () => {
    ...
    try {
      const { data: response } = await axios.post(API_URL, newuser);
          ...
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div>
                ...
                <div className="pb-6">
                  {error && (
                    <div className="flex -mx-3 bg-orange-600 text-white rounded-lg px-3 py-2 p-6">
                      {error}
                    </div>
                  )}
                </div>
                ...
                <div className="text-center underline-offset-0">
                  <button
                    onClick={login}
                    className="font-bold border-b-2 border-transparent hover:border-indigo-700"
                  >
                    <h1> Login </h1>
                  </button>
                </div>
